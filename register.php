...
if(isset($_POST) && !empty($_POST)){
    ...
    $sql = "INSERT INTO utilisateur"."(nom,prenom,role, created_at)"."VALUES".
    "('$nom','$prenom', '$role', '$datecreation')";
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            <div class="text-center">
                                <h1 class="h4 text-gray-900 mb-4">Creer un utilisteur</h1>
                            </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" class="form-control form-control-user" id="exampleLastName"
                                            placeholder="Nom de famille" name="nom">
                                    </div>
                                </div>
