                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <?php
                    $sql = "SELECT nom,prenom,role,created_at,token,update_at FROM utilisateur";
                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?=$row["update_at"]?></td>
                                            <td><a href="modifutilisteur.php?token=<?= $row["token"] ?>"><button
                                                        type="button" class="btn btn-primary">MODIFIER</button> </a>
                                            </td>
                                            <td><a href="supprimerutilisateur.php?token=<?= $row["token"] ?>"><button
                                                        type="button" class="btn btn-primary">SUPPRIMER</button>
                                                </a>
                                            </td>
                                        </tr>
